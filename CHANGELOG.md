...
- [New Term] Add `persist_new_terms` option to persist and restore seen terms across restarts via the `_past` writeback index - [#1770](https://github.com/jertel/elastalert2/pull/1770) - @MarcellZamboHu
