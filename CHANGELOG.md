...
- Import pyyaml-include(https://github.com/tanbro/pyyaml-include) to enable yaml includes another yaml - [#406](https://github.com/jertel/elastalert2/pull/406) - @iamxeph
