...
class SlackAlerter(Alerter):
    ...
    def __init__(self, rule):
        ...
        self.slack_attach_opensearch_discover_url = self.rule.get('slack_attach_kibana_discover_url', False)
        self.slack_opensearch_discover_color = self.rule.get('slack_kibana_discover_color', '#ec4b98')
        self.slack_opensearch_discover_title = self.rule.get('slack_kibana_discover_title', 'Discover in Opensearch')
