...
def test_rocket_chat_attach_opensearch_discover_url_when_generated():
    rule = {
        'name': 'Test Rule',
        'type': 'any',
        'alert_subject': 'Cool subject',
...
def test_rocket_chat_attach_opensearch_discover_url_when_not_generated():
    rule = {
        'name': 'Test Rule',
        'type': 'any',
        'alert_subject': 'Cool subject',
...
def test_rocket_chat_opensearch_discover_title():
    rule = {
        'name': 'Test Rule',
        'type': 'any',
        'alert_subject': 'Cool subject',
        ...
        'rocket_chat_webhook_url': 'http://please.dontgohere.rocketchat',
        'rocket_chat_attach_opensearch_discover_url': True,
        'rocket_chat_opensearch_discover_title': 'Click to discover in opensearch'
    }
...
def test_rocket_chat_opensearch_discover_color():
    rule = {
        'name': 'Test Rule',
        'type': 'any',
        'alert_text_type': 'alert_text_only',
        ...
        'rocket_chat_webhook_url': 'http://please.dontgohere.rocket_chat',
        'rocket_chat_attach_opensearch_discover_url': True,
        'rocket_chat_opensearch_discover_color': 'blue'
    }
