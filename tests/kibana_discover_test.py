...
def test_generate_kibana_discover_url_with_absolute_kinbana_discover_app_url():
    url = generate_kibana_discover_url(
        rule={
            'kibana_url': 'http://elasticsearch.test.org:9200/_plugin/kibana/',
    ...
    expectedUrl = (
        'http://kibana.test.org:5601/app/discover#/'
        + '?_g=%28'  # global start
        + 'filters%3A%21%28%29%2C'
        + 'refreshInterval%3A%28pause%3A%21t%2Cvalue%3A0%29%2C'
        + 'time%3A%28'  # time start
        ...
        + 'columns%3A%21%28_source%29%2C'
        + 'filters%3A%21%28%29%2C'
        + 'index%3A%27006eb191-2ffc-4269-a176-d1377f476a45%27%2C'
        + 'interval%3Aauto'
        + '%29'  # app end
    )
    assert url == expectedUrl
...
def test_generate_kibana_discover_url_with_absolute_path_kinbana_discover_app_url():
    url = generate_kibana_discover_url(
        rule={
            'kibana_url': 'http://kibana.test.org:5601',
            'kibana_discover_app_url': '/app/discover#/',
            'kibana_discover_version': '7.15',
            'kibana_discover_index_pattern_id': '28a92ee0-be50-4542-b1b4-9371abcbf1b9',
            'timestamp_field': 'timestamp'
        },
        match={
            'timestamp': '2021-10-08T00:30:00Z'
    ...
    expectedUrl = (
        ...
        + 'columns%3A%21%28_source%29%2C'
        + 'filters%3A%21%28%29%2C'
        + 'index%3A%2728a92ee0-be50-4542-b1b4-9371abcbf1b9%27%2C'
        + 'interval%3Aauto'
        + '%29'  # app end
    )
    assert url == expectedUrl
...
def test_generate_kibana_discover_url_with_relative_path_kinbana_discover_app_url():
    url = generate_kibana_discover_url(
        rule={
            'kibana_url': 'http://opensearch.test.org/_dashboards/',
            'kibana_discover_app_url': 'app/discover#/',
            'kibana_discover_version': '7.15',
    ...
    expectedUrl = (
        'http://opensearch.test.org/_dashboards/app/discover#/'
        + '?_g=%28'  # global start
        + 'filters%3A%21%28%29%2C'
        + 'refreshInterval%3A%28pause%3A%21t%2Cvalue%3A0%29%2C'
        + 'time%3A%28'  # time start
